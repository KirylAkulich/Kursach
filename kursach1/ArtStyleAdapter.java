...
public class ArtStyleAdapter extends RecyclerView.Adapter<ArtStyleAdapter.MyViewHolder> {
    ...
    public ArtStyleAdapter(Context context, List<ThumbnailItem> thumbnailItemList, ThumbnailsAdapterListener listener) {
        mContext = context;
